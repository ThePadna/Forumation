...
class CreateRanksTable extends Migration
{
    ...
    public function up()
    {
        ...
        $perms = array('admin', 'categoryadd', 'categoryswitch', 'categorydelete', 'categoryedit', 'posterase', 'threaddelete', 'threadlock', 'threadcreate', 'posteraseself', 'poststar', 'postcreate', 'editownprofile', 'editotherprofile', 'ban', 'sendmessage');
